...
class TokenizerTest {
    static Stream<Arguments> booleanTestCases() {
        return Stream.of(
                ...
                arguments("flase", List.of(new Token(TokenType.ERROR, "Unrecognized character: l", 1, 2))),
                arguments("ture", List.of(new Token(TokenType.ERROR, "Unrecognized character: u", 1, 2))),
